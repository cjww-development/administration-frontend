...
trait MockShutteringService extends BeforeAndAfterEach with MockitoSugar with Fixtures {
  self: PlaySpec =>

  val mockShutteringService: ShutteringService = mock[ShutteringService]

  override protected def beforeEach(): Unit = {
    super.beforeEach()
    reset(mockShutteringService)
  }
